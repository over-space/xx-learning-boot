package com.learning.netty.rpc.proxy;
...
public class RpcProxy {
    ...
    private static void invocationHandlerByRPC(RpcContent content, CompletableFuture<RpcResponse> completableFutureResponse) throws InterruptedException {
        ...
        // 4. 发送
        ByteBuf byteBuf = ByteUtil.createDirectBuffer(msgHeader.length + msgBody.length);
    ...
    private static void invocationHandlerByNettyHttp(RpcContent content, CompletableFuture<RpcResponse> completableFutureResponse) throws InterruptedException {
                        ...
                        channel.pipeline()
                                ...
                                .addLast(new ChannelInboundHandlerAdapter() {
                                    ...
                                    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
                                        ...
                                        RpcContent content = ByteUtil.toObject(response.content());
        ...
        // 发送数据
        byte[] contentBytes = ByteUtil.toByteArray(content);
        DefaultFullHttpRequest request = new DefaultFullHttpRequest(HttpVersion.HTTP_1_0, HttpMethod.POST, "/", ByteUtil.copiedBuffer(contentBytes));
